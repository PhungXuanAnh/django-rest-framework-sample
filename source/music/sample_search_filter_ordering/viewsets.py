...
from music.sample_search_filter_ordering.serializers import (
    MusicianModelSerializer_search_filter_ordering,
)
...
class MusicianListRetriveViews_Filter_Search_Order(
    mixins.ListModelMixin, mixins.RetrieveModelMixin, viewsets.GenericViewSet
):
    queryset = Musician.objects.all()
    serializer_class = MusicianModelSerializer_search_filter_ordering
