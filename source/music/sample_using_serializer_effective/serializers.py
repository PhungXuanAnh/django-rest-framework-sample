...
class MusicianModelSerializerReadEffective_SourceKeyword(serializers.ModelSerializer):
    ...
    full_address = serializers.CharField(
        source="profile.get_full_address", read_only=True
    )
    all_albums = AlbumModelSerializerReadEffective(
        source="album_set", many=True, read_only=True
    )
...
class MusicianModelSerializerReadEffective_SerializerMethod(
    ...
    class Meta:
        model = Musician
        fields = ["id", "first_name", "full_name", "instruments", "profile"]
